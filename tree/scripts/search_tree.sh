                    ...
                    for imputer in simple knn; do
                        for sample in none upsample downsample smote; do
                            ...
                            python main.py \
                                ...
                                --output_path log/year${year}/tree/${criterion}_depth=${max_depth}_split=${min_samples_split}_features=${max_features}_imputer=${imputer}_sample=${sample}_samplerate=${sample_rate} \
                                --imputer $imputer \
                                --sample $sample \
